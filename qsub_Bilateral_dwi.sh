...
if [ $ROIS = 1 ]; then
	...
	flirt -in ${EXPERIMENT}/Scripts/HOAsp.nii -ref ${OUTPUT}/bckedbm${SUBJ2}_dwi_b0.nii.gz -out ${OUTPUT}/${SUBJ2}_dwi_HOAsp -applyxfm -init ${OUTPUT}/${SUBJ2}_dwi_MNI_to_native.mat -bins 256 -cost corratio -searchrx -90 90 -searchry -90 90 -searchrz -90 90 -dof 12  -interp nearestneighbour 
...
if [ $ACTSEEDING = 1 ]; then
	...
	tcksift ${OUTPUT}/${SUBJ2}_dwi_seed_image_ACT.tck ${OUTPUT}/${SUBJ2}_dwi_FOD.nii.gz ${OUTPUT}/${SUBJ2}_dwi_SIFT_ACT.tck -fd_scale_gm -act ${OUTPUT}/tt_${SUBJ2}.mif -term_number 1M -force 
else
...
if [ $ACTCONNECTOME =  1 ]; then 
	...
	tcksample ${OUTPUT}/${SUBJ2}_dwi_seed_image_ACT.tck ${OUTPUT}/ckedbm${SUBJ2}_dwi_FA.nii.gz ${OUTPUT}/${SUBJ2}_dwi_ACT_FA_mean_tracks.csv -stat_tck mean -force
	tck2connectome ${OUTPUT}/${SUBJ2}_dwi_seed_image_ACT.tck ${OUTPUT}/${SUBJ2}_dwi_HOAsp.nii.gz ${OUTPUT}/${SUBJ2}_STRconnectome_ACT.csv  -force 
	tck2connectome ${OUTPUT}/${SUBJ2}_dwi_seed_image_ACT.tck ${OUTPUT}/${SUBJ2}_dwi_HOAsp.nii.gz ${OUTPUT}/${SUBJ2}_FAconnectome_ACT.csv -scale_file ${OUTPUT}/${SUBJ2}_dwi_ACT_FA_mean_tracks.csv -stat_edge mean -force
else
...
if [ $SIFTACTCONNECTOME =  1 ]; then 
	tcksample ${OUTPUT}/${SUBJ2}_dwi_SIFT_ACT.tck ${OUTPUT}/ckedbm${SUBJ2}_dwi_FA.nii.gz ${OUTPUT}/${SUBJ2}_dwi_SIFT_ACT_FA_mean_tracks.csv -stat_tck mean -force
	tck2connectome ${OUTPUT}/${SUBJ2}_dwi_SIFT_ACT.tck ${OUTPUT}/${SUBJ2}_dwi_HOAsp.nii.gz ${OUTPUT}/${SUBJ2}_STRconnectome_SIFTACT.csv  -force 
	tck2connectome ${OUTPUT}/${SUBJ2}_dwi_SIFT_ACT.tck ${OUTPUT}/${SUBJ2}_dwi_HOAsp.nii.gz ${OUTPUT}/${SUBJ2}_FAconnectome_SIFTACT.csv -scale_file ${OUTPUT}/${SUBJ2}_dwi_SIFT_ACT_FA_mean_tracks.csv -stat_edge mean -force
else
